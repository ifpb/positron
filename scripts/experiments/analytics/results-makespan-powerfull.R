...
for (scenario in scenarios) {
  ...
  filename <- paste("../results/JISA/", powerScenario, "/makespan-", scenario, "nodes.txt", sep = "")
...
ggsave(file=paste("makespan-", powerScenario, ".pdf", sep=""), height=7.0, width=10.0, units="in")