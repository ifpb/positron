...
#ifndef CONTROL_LAYER_CLIENT_H
#define CONTROL_LAYER_CLIENT_H
 ...
 * \brief A Control Layer client
 *
 * Every packet sent should be returned by the server and received here.
 */
class ControlLayerClient : public Application 
{
public:
  /**
