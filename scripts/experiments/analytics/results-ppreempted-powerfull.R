...
for (scenario in scenarios) {
  ...
  filename <- paste("../results/JISA/", powerScenario, "/ppreempted-", scenario, "nodes.txt", sep = "")
...
ggsave(file=paste("ppreempted-", powerScenario, ".pdf", sep=""), height=7.0, width=10.0, units="in")